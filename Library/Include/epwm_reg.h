...
typedef struct
{
     ...
     * |        |          |CMP will load to CMPBUF at the center point of a period
     ...
     * |        |          |CMP will load to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD will load to PBUF at the end point of each period
     * |        |          |CMP will load to CMPBUF at the end point of each period when valid reload window is set
     ...
     * |        |          |0 = PERIOD will load to PBUF at the end point of each period
     * |        |          |CMP will load to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMP will load to PBUF and CMPBUF immediately when software update PERIOD/CMP.
     ...
     * |        |          |0 = Noise filter of input pin EPWM0_SYNC_IN Disabled.
     * |        |          |1 = Noise filter of input pin EPWM0_SYNC_IN Enabled.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |SWSYNC0   |Software SYNC Function (Write Only)
     * |        |          |When SINSRCn (EPWM_SYNC[13:8]) is selected to 0, SYNC_OUT source comes from SYNC_IN or this bit.
     * |[1]     |SWSYNC2   |Software SYNC Function (Write Only)
     * |        |          |When SINSRCn (EPWM_SYNC[13:8]) is selected to 0, SYNC_OUT source comes from SYNC_IN or this bit.
     * |[2]     |SWSYNC4   |Software SYNC Function (Write Only)
     * |        |          |When SINSRCn (EPWM_SYNC[13:8]) is selected to 0, SYNC_OUT source comes from SYNC_IN or this bit.
     * @var EPWM_T::CLKSRC
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |LOAD0     |Re-load EPWM Comparator Register Control Bit
     * |        |          |This bit is software write to reload EPWM_CMPDATn, n=0~5. Hardware clear when current EPWM period end.
     * |        |          |Write Operation:
     * |        |          |0 = No effect.
     ...
     * |[1]     |LOAD1     |Re-load EPWM Comparator Register Control Bit
     * |        |          |This bit is software write to reload EPWM_CMPDATn, n=0~5. Hardware clear when current EPWM period end.
     * |        |          |Write Operation:
     * |        |          |0 = No effect.
     * |        |          |1 = Set load window of window loading mode.
     ...
     * |        |          |1 = Load window is set.
     * |        |          |Note: This bit only use in window loading mode, WINLDENn(EPWM_CTL0[13:8]) = 1.
     * |[2]     |LOAD2     |Re-load EPWM Comparator Register Control Bit
     * |        |          |This bit is software write to reload EPWM_CMPDATn, n=0~5. Hardware clear when current EPWM period end.
     * |        |          |Write Operation:
     * |        |          |0 = No effect.
     * |        |          |1 = Set load window of window loading mode.
     ...
     * |        |          |1 = Load window is set.
     * |        |          |Note: This bit only use in window loading mode, WINLDENn(EPWM_CTL0[13:8]) = 1.
     * |[3]     |LOAD3     |Re-load EPWM Comparator Register Control Bit
     * |        |          |This bit is software write to reload EPWM_CMPDATn, n=0~5. Hardware clear when current EPWM period end.
     * |        |          |Write Operation:
     * |        |          |0 = No effect.
     * |        |          |1 = Set load window of window loading mode.
     ...
     * |        |          |1 = Load window is set.
     * |        |          |Note: This bit only use in window loading mode, WINLDENn(EPWM_CTL0[13:8]) = 1.
     * |[4]     |LOAD4     |Re-load EPWM Comparator Register Control Bit
     * |        |          |This bit is software write to reload EPWM_CMPDATn, n=0~5. Hardware clear when current EPWM period end.
     * |        |          |Write Operation:
     * |        |          |0 = No effect.
     * |        |          |1 = Set load window of window loading mode.
     ...
     * |        |          |1 = Load window is set.
     * |        |          |Note: This bit only use in window loading mode, WINLDENn(EPWM_CTL0[13:8]) = 1.
     * |[5]     |LOAD5     |Re-load EPWM Comparator Register Control Bit
     * |        |          |This bit is software write to reload EPWM_CMPDATn, n=0~5. Hardware clear when current EPWM period end.
     * |        |          |Write Operation:
     * |        |          |0 = No effect.
     * |        |          |1 = Set load window of window loading mode.
     ...
     * |        |          |EPWM period time = (PERIOD+1) * (CLKPSC+1) * EPWM_CLK .
     * |        |          |Down-Count mode:
     * |        |          |In this mode, EPWM counter counts from PERIOD to 0, and restarts from PERIOD.
     * |        |          |EPWM period time = (PERIOD+1) * (CLKPSC+1) * EPWM_CLK .
     * |        |          |Up-Down-Count mode:
     * |        |          |In this mode, EPWM counter counts from 0 to PERIOD, then decrements to 0 and repeats again.
     * |        |          |EPWM period time = 2 * PERIOD * (CLKPSC+1) * EPWM_CLK.
     * @var EPWM_T::CMPDAT[6]
     ...
     * |        |          |In independent mode, EPWM_CMPDATn, n=0,1..5 denote as 6 independent EPWM_CH0~5 compared point.
     ...
     * |        |          |10 = EPWM zero point output High.
     * |        |          |11 = EPWM zero point output Toggle.
     * |[17:16] |PRDPCTL0  |EPWM Period or Center Point Control
     ...
     * |[19:18] |PRDPCTL1  |EPWM Period or Center Point Control
     * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
     * |        |          |00 = Do nothing.
     * |        |          |01 = EPWM period (center) point output Low.
     * |        |          |10 = EPWM period (center) point output High.
     * |        |          |11 = EPWM period (center) point output Toggle.
     * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
     * |[21:20] |PRDPCTL2  |EPWM Period or Center Point Control
     * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
     * |        |          |00 = Do nothing.
     * |        |          |01 = EPWM period (center) point output Low.
     * |        |          |10 = EPWM period (center) point output High.
     * |        |          |11 = EPWM period (center) point output Toggle.
     * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
     * |[23:22] |PRDPCTL3  |EPWM Period or Center Point Control
     * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
     * |        |          |00 = Do nothing.
     * |        |          |01 = EPWM period (center) point output Low.
     * |        |          |10 = EPWM period (center) point output High.
     * |        |          |11 = EPWM period (center) point output Toggle.
     * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
     * |[25:24] |PRDPCTL4  |EPWM Period or Center Point Control
     * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
     * |        |          |00 = Do nothing.
     * |        |          |01 = EPWM period (center) point output Low.
     * |        |          |10 = EPWM period (center) point output High.
     * |        |          |11 = EPWM period (center) point output Toggle.
     * |        |          |Note: This bit is center point control when EPWM counter operating in up-down counter type.
     * |[27:26] |PRDPCTL5  |EPWM Period or Center Point Control
     * |        |          |EPWM can control output level when EPWM counter counts to (PERIODn+1).
     * |        |          |00 = Do nothing.
     * |        |          |01 = EPWM period (center) point output Low.
     * |        |          |10 = EPWM period (center) point output High.
     ...
     * |        |          |0 = brake pin event will be detected if EPWMx_BRAKE0 pin status transfer from low to high in edge-detect, or pin status is high in level-detect.
     * |        |          |1 = brake pin event will be detected if EPWMx_BRAKE0 pin status transfer from high to low in edge-detect, or pin status is low in level-detect.
     ...
     * |        |          |0 = brake pin event will be detected if EPWMx_BRAKE1 pin status transfer from low to high in edge-detect, or pin status is high in level-detect.
     * |        |          |1 = brake pin event will be detected if EPWMx_BRAKE1 pin status transfer from high to low in edge-detect, or pin status is low in level-detect.
     ...
     * |        |          |0 = ACMP2_O as edge-detect brake source Disabled.
     * |        |          |1 = ACMP2_O as edge-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
     * |[3]     |CPO3EBEN  |Enable ACMP3_O Digital Output As Edge-detect Brake Source (Write Protect)
     * |        |          |0 = ACMP3_O as edge-detect brake source Disabled.
     * |        |          |1 = ACMP3_O as edge-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
     ...
     * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
     * |[10]    |CPO2LBEN  |Enable ACMP2_O Digital Output As Level-detect Brake Source (Write Protect)
     * |        |          |0 = ACMP2_O as level-detect brake source Disabled.
     * |        |          |1 = ACMP2_O as level-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
     * |[11]    |CPO3LBEN  |Enable ACMP3_O Digital Output As Level-detect Brake Source (Write Protect)
     * |        |          |0 = ACMP3_O as level-detect brake source Disabled.
     * |        |          |1 = ACMP3_O as level-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer toSYS_REGLCTL register.
     ...
     * |[20]    |EADC0EBEN |Enable EADC0 Result Monitor as Edge-detect Brake Source (Write Protect)
     * |        |          |0 = EADC0RM as edge-detect brake source Disabled.
     * |        |          |1 = EADC0RM as edge-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[21]    |EADC1EBEN |Enable EADC1 Result Monitor as Edge-detect Brake Source (Write Protect)
     * |        |          |0 = EADC1RM as edge-detect brake source Disabled.
     * |        |          |1 = EADC1RM as edge-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     ...
     * |        |          |0 = EADC0RM as level-detect brake source Disabled.
     * |        |          |1 = EADC0RM as level-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[29]    |EADC1LBEN |Enable EADC1 Result Monitor as Level-detect Brake Source (Write Protect)
     * |        |          |0 = EADC1RM as level-detect brake source Disabled.
     * |        |          |1 = EADC1RM as level-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[30]    |EADC2LBEN |Enable EADC2 Result Monitor as Level-detect Brake Source (Write Protect)
     * |        |          |0 = EADC2RM as level-detect brake source Disabled.
     * |        |          |1 = EADC2RM as level-detect brake source Enabled.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * @var EPWM_T::POLCTL
     ...
     * |        |          |0 = EPWMx_CHn output pin polar inverse Disabled.
     * |        |          |1 = EPWMx_CHn output pin polar inverse Enabled.
     ...
     * |        |          |0 = EPWMx_CHn pin at tri-state.
     * |        |          |1 = EPWMx_CHn pin in output mode.
     ...
     * |        |          |When edge-detect brake interrupt flag is cleared, EPWM will release brake state until current EPWM period finished
     ...
     * |        |          |EPWM can trigger DAC to start action when EPWM counter down count to zero if this bit is set to1.
     ...
     * |        |          |0 = EPWM period point trigger DAC function Disabled.
     * |        |          |1 = EPWM period point trigger DAC function Enabled.
     * |[16]    |CUTRGEN0  |EPWM Compare Up Count Point Trigger DAC Enable Bits
     ...
     * |[17]    |CUTRGEN1  |EPWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[18]    |CUTRGEN2  |EPWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[19]    |CUTRGEN3  |EPWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[20]    |CUTRGEN4  |EPWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[21]    |CUTRGEN5  |EPWM Compare Up Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter counts up to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Up point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Up point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in down counter type.
     * |        |          |Note 2: In complementary mode, CUTRGEN1, 3, 5 is used as another CUTRGEN for channel 0, 2, 4.
     * |[24]    |CDTRGEN0  |EPWM Compare Down Count Point Trigger DAC Enable Bits
     ...
     * |[25]    |CDTRGEN1  |EPWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[26]    |CDTRGEN2  |EPWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[27]    |CDTRGEN3  |EPWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[28]    |CDTRGEN4  |EPWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in up counter type.
     * |        |          |Note 2: In complementary mode, CDTRGEN1, 3, 5 is used as another CDTRGEN for channel 0, 2, 4.
     * |[29]    |CDTRGEN5  |EPWM Compare Down Count Point Trigger DAC Enable Bits
     * |        |          |EPWM can trigger DAC to start action when EPWM counter down count to CMP if this bit is set to1.
     * |        |          |0 = EPWM Compare Down count point trigger DAC function Disabled.
     * |        |          |1 = EPWM Compare Down count point trigger DAC function Enabled.
     * |        |          |Note 1: This bit should keep at 0 when EPWM counter operating in up counter type.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[4:0]   |TRGSEL0   |EPWM_CH0 Trigger EADC Source Select
     * |        |          |00000 = EPWM_CH0 zero point.
     * |        |          |00001 = EPWM_CH0 period point.
     * |        |          |00010 = EPWM_CH0 zero or period point.
     * |        |          |00011 = EPWM_CH0 up-count compared point.
     * |        |          |00100 = EPWM_CH0 down-count compared point.
     * |        |          |00101 = EPWM_CH1 zero point.
     * |        |          |00110 = EPWM_CH1 period point.
     * |        |          |00111 = EPWM_CH1 zero or period point.
     * |        |          |01000 = EPWM_CH1 up-count compared point.
     * |        |          |01001 = EPWM_CH1 down-count compared point.
     * |        |          |01010 = EPWM_CH0 up-count free trigger compared point.
     * |        |          |01011 = EPWM_CH0 down-count free trigger compared point.
     * |        |          |01100 = EPWM_CH2 up-count free trigger compared point.
     * |        |          |01101 = EPWM_CH2 down-count free trigger compared point.
     * |        |          |01110 = EPWM_CH4 up-count free trigger compared point.
     * |        |          |01111 = EPWM_CH4 down-count free trigger compared point.
     ...
     * |[12:8]  |TRGSEL1   |EPWM_CH1 Trigger EADC Source Select
     * |        |          |00000 = EPWM_CH0 zero point.
     * |        |          |00001 = EPWM_CH0 period point.
     * |        |          |00010 = EPWM_CH0 zero or period point.
     * |        |          |00011 = EPWM_CH0 up-count compared point.
     ...
     * |[20:16] |TRGSEL2   |EPWM_CH2 Trigger EADC Source Select
     * |        |          |00000 = EPWM_CH2 zero point.
     * |        |          |00001 = EPWM_CH2 period point.
     * |        |          |00010 = EPWM_CH2 zero or period point.
     * |        |          |00011 = EPWM_CH2 up-count compared point.
     * |        |          |00100 = EPWM_CH2 down-count compared point.
     * |        |          |00101 = EPWM_CH3 zero point.
     * |        |          |00110 = EPWM_CH3 period point.
     * |        |          |00111 = EPWM_CH3 zero or period point.
     * |        |          |01000 = EPWM_CH3 up-count compared point.
     * |        |          |01001 = EPWM_CH3 down-count compared point.
     * |        |          |01010 = EPWM_CH0 up-count free trigger compared point.
     * |        |          |01011 = EPWM_CH0 down-count free trigger compared point.
     * |        |          |01100 = EPWM_CH2 up-count free trigger compared point.
     * |        |          |01101 = EPWM_CH2 down-count free trigger compared point.
     ...
     * |[28:24] |TRGSEL3   |EPWM_CH3 Trigger EADC Source Select
     * |        |          |00000 = EPWM_CH2 zero point.
     * |        |          |00001 = EPWM_CH2 period point.
     * |        |          |00010 = EPWM_CH2 zero or period point.
     * |        |          |00011 = EPWM_CH2 up-count compared point.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[4:0]   |TRGSEL4   |EPWM_CH4 Trigger EADC Source Select
     * |        |          |00000 = EPWM_CH4 zero point.
     * |        |          |00001 = EPWM_CH4 period point.
     * |        |          |00010 = EPWM_CH4 zero or period point.
     * |        |          |00011 = EPWM_CH4 up-count compared point.
     * |        |          |00100 = EPWM_CH4 down-count compared point.
     * |        |          |00101 = EPWM_CH5 zero point.
     * |        |          |00110 = EPWM_CH5 period point.
     * |        |          |00111 = EPWM_CH5 zero or period point.
     * |        |          |01000 = EPWM_CH5 up-count compared point.
     * |        |          |01001 = EPWM_CH5 down-count compared point.
     * |        |          |01010 = EPWM_CH0 up-count free trigger compared point.
     * |        |          |01011 = EPWM_CH0 down-count free trigger compared point.
     * |        |          |01100 = EPWM_CH2 up-count free trigger compared point.
     * |        |          |01101 = EPWM_CH2 down-count free trigger compared point.
     ...
     * |[12:8]  |TRGSEL5   |EPWM_CH5 Trigger EADC Source Select
     * |        |          |00000 = EPWM_CH4 zero point.
     * |        |          |00001 = EPWM_CH4 period point.
     * |        |          |00010 = EPWM_CH4 zero or period point.
     * |        |          |00011 = EPWM_CH4 up-count compared point.
     ...
     * |        |          |FTCMP use to compare with even CNT (EPWM_CNTm[15:0], m=0,2,4) to trigger EADC
     * |        |          |EPWM_FTCMPDAT0_1, EPWM_FTCMPDAT2_3, EPWM_FTCMPDAT4_5 corresponding complementary pairs EPWM_CH0and EPWM_CH1, EPWM_CH2 and EPWM_CH3, EPWM_CH4 and EPWM_CH5.
     * @var EPWM_T::SSCTL
     ...
     * |        |          |0 = No SYNC_IN event has occurred.
     * |        |          |1 = A SYNC_IN event has occurred.
     * |        |          |Note: This bit can be cleared by software writing 1.
     ...
     * |[24]    |STPMOD    |EPWM_CHn Accumulator Stop Mode Enable Bits
     * |        |          |0 = EPWM_CHn Stop Mode Disabled.
     * |        |          |1 = EPWM_CHn Stop Mode Enabled.
     * |[29:28] |IFASEL    |EPWM_CHn Interrupt Flag Accumulator Source Select
     * |        |          |00 = EPWM_CHn zero point.
     * |        |          |01 = EPWM_CHn period in channel n.
     * |        |          |10 = EPWM_CHn up-count compared point.
     * |        |          |11 = EPWM_CHn down-count compared point.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |FDEN0     |EPWM Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[1]     |FDEN1     |EPWM Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[2]     |FDEN2     |EPWM Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[3]     |FDEN3     |EPWM Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[4]     |FDEN4     |EPWM Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[5]     |FDEN5     |EPWM Fault Detect Function Enable Bit
     * |        |          |0 = Fault detect function Disabled.
     * |        |          |1 = Fault detect function Enabled.
     * |[8]     |FDODIS0   |EPWM Channel n Output Fault Detect Disable Bit
     * |        |          |0 = EPWM detect fault and output Enabled.
     * |        |          |1 = EPWM detect fault and output Disabled.
     * |[9]     |FDODIS1   |EPWM Channel n Output Fault Detect Disable Bit
     * |        |          |0 = EPWM detect fault and output Enabled.
     * |        |          |1 = EPWM detect fault and output Disabled.
     * |[10]    |FDODIS2   |EPWM Channel n Output Fault Detect Disable Bit
     * |        |          |0 = EPWM detect fault and output Enabled.
     * |        |          |1 = EPWM detect fault and output Disabled.
     * |[11]    |FDODIS3   |EPWM Channel n Output Fault Detect Disable Bit
     * |        |          |0 = EPWM detect fault and output Enabled.
     * |        |          |1 = EPWM detect fault and output Disabled.
     * |[12]    |FDODIS4   |EPWM Channel n Output Fault Detect Disable Bit
     * |        |          |0 = EPWM detect fault and output Enabled.
     * |        |          |1 = EPWM detect fault and output Disabled.
     * |[13]    |FDODIS5   |EPWM Channel n Output Fault Detect Disable Bit
     * |        |          |0 = EPWM detect fault and output Enabled.
     * |        |          |1 = EPWM detect fault and output Disabled.
     * |[16]    |FDCKS0    |EPWM Channel n Fault Detect Clock Source Select Bit
     * |        |          |0 = EPWMx_CLK, x denotes 0 or 1.
     * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0 or 1.
     * |[17]    |FDCKS1    |EPWM Channel n Fault Detect Clock Source Select Bit
     * |        |          |0 = EPWMx_CLK, x denotes 0 or 1.
     * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0 or 1.
     * |[18]    |FDCKS2    |EPWM Channel n Fault Detect Clock Source Select Bit
     * |        |          |0 = EPWMx_CLK, x denotes 0 or 1.
     * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0 or 1.
     * |[19]    |FDCKS3    |EPWM Channel n Fault Detect Clock Source Select Bit
     * |        |          |0 = EPWMx_CLK, x denotes 0 or 1.
     * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0 or 1.
     * |[20]    |FDCKS4    |EPWM Channel n Fault Detect Clock Source Select Bit
     * |        |          |0 = EPWMx_CLK, x denotes 0 or 1.
     * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0 or 1.
     * |[21]    |FDCKS5    |EPWM Channel n Fault Detect Clock Source Select Bit
     * |        |          |0 = EPWMx_CLK, x denotes 0 or 1.
     * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0 or 1.
     * @var EPWM_T::FDCTL0
     ...
     * |        |          |0 = Capture function Disabled. EPWM_RCAPDATn/EPWM_FCAPDATn register will not be updated.
     ...
     * |        |          |Note: This bit will be cleared automatically when user clears corresponding CRLIFn(EPWM_CAPIF[n]).
     ...
     * |        |          |Note: This bit will be cleared automatically when user clears corresponding CFLIFn(EPWM_CAPIF[8+n]).
     ...
     * |        |          |Note 2: This bit is cleared by writing 1 to it.
     * @var EPWM_T::CAPNF0
     * Offset: 0x258  EPWM Capture Input Noise Filter Register 0
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EPWM_T::CAPNF1
     * Offset: 0x25C  EPWM Capture Input Noise Filter Register 1
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPNFEN   |Capture Noise Filter Enable
     ...
     * |        |          |The register bits control the capture filter counter to count from 0 to CAPNFCNT.
     * @var EPWM_T::CAPNF2
     * Offset: 0x260  EPWM Capture Input Noise Filter Register 2
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPNFEN   |Capture Noise Filter Enable
     ...
     * |        |          |The register bits control the capture filter counter to count from 0 to CAPNFCNT.
     * @var EPWM_T::CAPNF3
     * Offset: 0x264  EPWM Capture Input Noise Filter Register 3
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPNFEN   |Capture Noise Filter Enable
     ...
     * |        |          |The register bits control the capture filter counter to count from 0 to CAPNFCNT.
     * @var EPWM_T::CAPNF4
     * Offset: 0x268  EPWM Capture Input Noise Filter Register 4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPNFEN   |Capture Noise Filter Enable
     ...
     * |        |          |The register bits control the capture filter counter to count from 0 to CAPNFCNT.
     * @var EPWM_T::CAPNF5
     * Offset: 0x26C  EPWM Capture Input Noise Filter Register 5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPNFEN   |Capture Noise Filter Enable
     ...
     * |[10:8]  |CAPNFCNT  |Capture Edge Detector Noise Filter Count
     * |        |          |The register bits control the capture filter counter to count from 0 to CAPNFCNT.
     * @var EPWM_T::EXTETCTL0
     * Offset: 0x270  EPWM External Event Trigger Control Register 0
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |0111 = INT7.
     * |        |          |Other = Reserved.
     * @var EPWM_T::EXTETCTL1
     * Offset: 0x274  EPWM External Event Trigger Control Register 1
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EXETEN    |External Event Trigger Enable Bit
     ...
     * |        |          |0111 = INT7.
     * |        |          |Other = Reserved.
     * @var EPWM_T::EXTETCTL2
     * Offset: 0x278  EPWM External Event Trigger Control Register 2
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EXETEN    |External Event Trigger Enable Bit
     ...
     * |        |          |0111 = INT7.
     * |        |          |Other = Reserved.
     * @var EPWM_T::EXTETCTL3
     * Offset: 0x27C  EPWM External Event Trigger Control Register 3
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EXETEN    |External Event Trigger Enable Bit
     ...
     * |        |          |0111 = INT7.
     * |        |          |Other = Reserved.
     * @var EPWM_T::EXTETCTL4
     * Offset: 0x280  EPWM External Event Trigger Control Register 4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EXETEN    |External Event Trigger Enable Bit
     ...
     * |        |          |0111 = INT7.
     * |        |          |Other = Reserved.
     * @var EPWM_T::EXTETCTL5
     * Offset: 0x284  EPWM External Event Trigger Control Register 5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EXETEN    |External Event Trigger Enable Bit
     ...
     * |        |          |The clock of EPWM counter is divided by (CLKPSC+ 1)
     * @var EPWM_T::CLKPSC2
     * Offset: 0x298  EPWM Clock Prescale Register 2
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CLKPSC    |EPWM Counter Clock Prescale
     ...
     * |        |          |The clock of EPWM counter is divided by (CLKPSC+ 1)
     * @var EPWM_T::CLKPSC3
     * Offset: 0x29C  EPWM Clock Prescale Register 3
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CLKPSC    |EPWM Counter Clock Prescale
     ...
     * |        |          |The clock of EPWM counter is divided by (CLKPSC+ 1)
     * @var EPWM_T::CLKPSC4
     * Offset: 0x2A0  EPWM Clock Prescale Register 4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CLKPSC    |EPWM Counter Clock Prescale
     ...
     * |        |          |The clock of EPWM counter is divided by (CLKPSC+ 1)
     * @var EPWM_T::CLKPSC5
     * Offset: 0x2A4  EPWM Clock Prescale Register 5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CLKPSC    |EPWM Counter Clock Prescale
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |RDTEN0    |Enable Rising Dead-time Insertion for EPWM Pair (Write Protect)
     ...
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[1]     |RDTEN2    |Enable Rising Dead-time Insertion for EPWM Pair (Write Protect)
     * |        |          |Rising Dead-time insertion is only active when this pair of complementary EPWM is enabled
     * |        |          |If rising dead- time insertion is inactive, the outputs of pin pair are complementary without any delay.
     * |        |          |0 = Rising Dead-time insertion Disabled on the pin pair.
     * |        |          |1 = Rising Dead-time insertion Enabled on the pin pair.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[2]     |RDTEN4    |Enable Rising Dead-time Insertion for EPWM Pair (Write Protect)
     * |        |          |Rising Dead-time insertion is only active when this pair of complementary EPWM is enabled
     * |        |          |If rising dead- time insertion is inactive, the outputs of pin pair are complementary without any delay.
     * |        |          |0 = Rising Dead-time insertion Disabled on the pin pair.
     * |        |          |1 = Rising Dead-time insertion Enabled on the pin pair.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[8]     |FDTEN0    |Enable Falling Dead-time Insertion for EPWM Pair (Write Protect)
     ...
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[9]     |FDTEN2    |Enable Falling Dead-time Insertion for EPWM Pair (Write Protect)
     * |        |          |Falling Dead-time insertion is only active when this pair of complementary EPWM is enabled
     * |        |          |If falling dead- time insertion is inactive, the outputs of pin pair are complementary without any delay.
     * |        |          |0 = Falling Dead-time insertion Disabled on the pin pair.
     * |        |          |1 = Falling Dead-time insertion Enabled on the pin pair.
     * |        |          |Note: This bit is write protected. Refer to SYS_REGLCTL register.
     * |[10]    |FDTEN4    |Enable Falling Dead-time Insertion for EPWM Pair (Write Protect)
     * |        |          |Falling Dead-time insertion is only active when this pair of complementary EPWM is enabled
     * |        |          |If falling dead- time insertion is inactive, the outputs of pin pair are complementary without any delay.
     * |        |          |0 = Falling Dead-time insertion Disabled on the pin pair.
     * |        |          |1 = Falling Dead-time insertion Enabled on the pin pair.
     ...
     * |        |          |Indicator is set by hardware when EPWM counter up counts and reaches EPWM_FTCMPDATn
     * |        |          |Software can clear this bit by writing 1 to it.
     ...
     * |        |          |Indicator is set by hardware when EPWM counter down counts and reaches EPWM_FTCMPDATn
     * |        |          |Software can clear this bit by writing 1 to it.
     ...
     * |        |          |Software can clear this bit by writing 1 to it.
     * @var EPWM_T::CPSCBUF0
     * Offset: 0x350  EPWM CLKPSC0 Buffer
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     ...
     * @var EPWM_T::CPSCBUF1
     * Offset: 0x354  EPWM CLKPSC1 Buffer
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF2
     * Offset: 0x358  EPWM CLKPSC2 Buffer
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF3
     * Offset: 0x35C  EPWM CLKPSC3 Buffer
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF4
     * Offset: 0x360  EPWM CLKPSC4 Buffer
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::CPSCBUF5
     * Offset: 0x364  EPWM CLKPSC5 Buffer
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[11:0]  |CPSCBUF   |EPWM Counter Clock Prescale Buffer
     * |        |          |Used as EPWM counter clock pre-scare active register.
     * @var EPWM_T::IFACNT0
     * Offset: 0x368  EPWM Interrupt Flag Accumulator Counter 0
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EPWM_T::IFACNT1
     * Offset: 0x36C  EPWM Interrupt Flag Accumulator Counter 1
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT2
     * Offset: 0x370  EPWM Interrupt Flag Accumulator Counter 2
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT3
     * Offset: 0x374  EPWM Interrupt Flag Accumulator Counter 3
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT4
     * Offset: 0x378  EPWM Interrupt Flag Accumulator Counter 4
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
     * |        |          |This value indicates how many interrupt are accumulated when using interrupt flag accumulator function.
     * @var EPWM_T::IFACNT5
     * Offset: 0x37C  EPWM Interrupt Flag Accumulator Counter 5
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |ACUCNT    |Accumulator Counter (Read Only)
...
#define EPWM_BRKCTL0_1_CPO2EBEN_Pos       (2)                                               /*!< EPWM_T::BRKCTL0_1: CPO2EBEN Position     */
#define EPWM_BRKCTL0_1_CPO2EBEN_Msk       (0x1ul << EPWM_BRKCTL0_1_CPO2EBEN_Pos)            /*!< EPWM_T::BRKCTL0_1: CPO2EBEN Mask         */

#define EPWM_BRKCTL0_1_CPO3EBEN_Pos       (3)                                               /*!< EPWM_T::BRKCTL0_1: CPO3EBEN Position     */
#define EPWM_BRKCTL0_1_CPO3EBEN_Msk       (0x1ul << EPWM_BRKCTL0_1_CPO3EBEN_Pos)            /*!< EPWM_T::BRKCTL0_1: CPO3EBEN Mask         */
...
#define EPWM_BRKCTL0_1_CPO2LBEN_Pos       (10)                                              /*!< EPWM_T::BRKCTL0_1: CPO2LBEN Position     */
#define EPWM_BRKCTL0_1_CPO2LBEN_Msk       (0x1ul << EPWM_BRKCTL0_1_CPO2LBEN_Pos)            /*!< EPWM_T::BRKCTL0_1: CPO2LBEN Mask         */

#define EPWM_BRKCTL0_1_CPO3LBEN_Pos       (11)                                              /*!< EPWM_T::BRKCTL0_1: CPO3LBEN Position     */
#define EPWM_BRKCTL0_1_CPO3LBEN_Msk       (0x1ul << EPWM_BRKCTL0_1_CPO3LBEN_Pos)            /*!< EPWM_T::BRKCTL0_1: CPO3LBEN Mask         */
...
#define EPWM_BRKCTL0_1_EADC1EBEN_Pos      (21)                                              /*!< EPWM_T::BRKCTL0_1: EADC1EBEN Position    */
#define EPWM_BRKCTL0_1_EADC1EBEN_Msk      (0x1ul << EPWM_BRKCTL0_1_EADC1EBEN_Pos)           /*!< EPWM_T::BRKCTL0_1: EADC1EBEN Mask        */

#define EPWM_BRKCTL0_1_EADC2EBEN_Pos      (22)                                              /*!< EPWM_T::BRKCTL0_1: EADC2EBEN Position    */
#define EPWM_BRKCTL0_1_EADC2EBEN_Msk      (0x1ul << EPWM_BRKCTL0_1_EADC2EBEN_Pos)           /*!< EPWM_T::BRKCTL0_1: EADC2EBEN Mask        */
...
#define EPWM_BRKCTL0_1_EADC1LBEN_Pos      (29)                                              /*!< EPWM_T::BRKCTL0_1: EADC1LBEN Position    */
#define EPWM_BRKCTL0_1_EADC1LBEN_Msk      (0x1ul << EPWM_BRKCTL0_1_EADC1LBEN_Pos)           /*!< EPWM_T::BRKCTL0_1: EADC1LBEN Mask        */

#define EPWM_BRKCTL0_1_EADC2LBEN_Pos      (30)                                              /*!< EPWM_T::BRKCTL0_1: EADC2LBEN Position    */
#define EPWM_BRKCTL0_1_EADC2LBEN_Msk      (0x1ul << EPWM_BRKCTL0_1_EADC2LBEN_Pos)           /*!< EPWM_T::BRKCTL0_1: EADC2LBEN Mask        */
...
#define EPWM_BRKCTL2_3_CPO2EBEN_Pos       (2)                                               /*!< EPWM_T::BRKCTL2_3: CPO2EBEN Position     */
#define EPWM_BRKCTL2_3_CPO2EBEN_Msk       (0x1ul << EPWM_BRKCTL2_3_CPO2EBEN_Pos)            /*!< EPWM_T::BRKCTL2_3: CPO2EBEN Mask         */

#define EPWM_BRKCTL2_3_CPO3EBEN_Pos       (3)                                               /*!< EPWM_T::BRKCTL2_3: CPO3EBEN Position     */
#define EPWM_BRKCTL2_3_CPO3EBEN_Msk       (0x1ul << EPWM_BRKCTL2_3_CPO3EBEN_Pos)            /*!< EPWM_T::BRKCTL2_3: CPO3EBEN Mask         */
...
#define EPWM_BRKCTL2_3_CPO2LBEN_Pos       (10)                                              /*!< EPWM_T::BRKCTL2_3: CPO2LBEN Position     */
#define EPWM_BRKCTL2_3_CPO2LBEN_Msk       (0x1ul << EPWM_BRKCTL2_3_CPO2LBEN_Pos)            /*!< EPWM_T::BRKCTL2_3: CPO2LBEN Mask         */

#define EPWM_BRKCTL2_3_CPO3LBEN_Pos       (11)                                              /*!< EPWM_T::BRKCTL2_3: CPO3LBEN Position     */
#define EPWM_BRKCTL2_3_CPO3LBEN_Msk       (0x1ul << EPWM_BRKCTL2_3_CPO3LBEN_Pos)            /*!< EPWM_T::BRKCTL2_3: CPO3LBEN Mask         */
...
#define EPWM_BRKCTL2_3_EADC1EBEN_Pos      (21)                                              /*!< EPWM_T::BRKCTL2_3: EADC1EBEN Position    */
#define EPWM_BRKCTL2_3_EADC1EBEN_Msk      (0x1ul << EPWM_BRKCTL2_3_EADC1EBEN_Pos)           /*!< EPWM_T::BRKCTL2_3: EADC1EBEN Mask        */

#define EPWM_BRKCTL2_3_EADC2EBEN_Pos      (22)                                              /*!< EPWM_T::BRKCTL2_3: EADC2EBEN Position    */
#define EPWM_BRKCTL2_3_EADC2EBEN_Msk      (0x1ul << EPWM_BRKCTL2_3_EADC2EBEN_Pos)           /*!< EPWM_T::BRKCTL2_3: EADC2EBEN Mask        */
...
#define EPWM_BRKCTL2_3_EADC1LBEN_Pos      (29)                                              /*!< EPWM_T::BRKCTL2_3: EADC1LBEN Position    */
#define EPWM_BRKCTL2_3_EADC1LBEN_Msk      (0x1ul << EPWM_BRKCTL2_3_EADC1LBEN_Pos)           /*!< EPWM_T::BRKCTL2_3: EADC1LBEN Mask        */

#define EPWM_BRKCTL2_3_EADC2LBEN_Pos      (30)                                              /*!< EPWM_T::BRKCTL2_3: EADC2LBEN Position    */
#define EPWM_BRKCTL2_3_EADC2LBEN_Msk      (0x1ul << EPWM_BRKCTL2_3_EADC2LBEN_Pos)           /*!< EPWM_T::BRKCTL2_3: EADC2LBEN Mask        */
...
#define EPWM_BRKCTL4_5_CPO2EBEN_Pos       (2)                                               /*!< EPWM_T::BRKCTL4_5: CPO2EBEN Position     */
#define EPWM_BRKCTL4_5_CPO2EBEN_Msk       (0x1ul << EPWM_BRKCTL4_5_CPO2EBEN_Pos)            /*!< EPWM_T::BRKCTL4_5: CPO2EBEN Mask         */

#define EPWM_BRKCTL4_5_CPO3EBEN_Pos       (3)                                               /*!< EPWM_T::BRKCTL4_5: CPO3EBEN Position     */
#define EPWM_BRKCTL4_5_CPO3EBEN_Msk       (0x1ul << EPWM_BRKCTL4_5_CPO3EBEN_Pos)            /*!< EPWM_T::BRKCTL4_5: CPO3EBEN Mask         */
...
#define EPWM_BRKCTL4_5_CPO2LBEN_Pos       (10)                                              /*!< EPWM_T::BRKCTL4_5: CPO2LBEN Position     */
#define EPWM_BRKCTL4_5_CPO2LBEN_Msk       (0x1ul << EPWM_BRKCTL4_5_CPO2LBEN_Pos)            /*!< EPWM_T::BRKCTL4_5: CPO2LBEN Mask         */

#define EPWM_BRKCTL4_5_CPO3LBEN_Pos       (11)                                              /*!< EPWM_T::BRKCTL4_5: CPO3LBEN Position     */
#define EPWM_BRKCTL4_5_CPO3LBEN_Msk       (0x1ul << EPWM_BRKCTL4_5_CPO3LBEN_Pos)            /*!< EPWM_T::BRKCTL4_5: CPO3LBEN Mask         */
...
#define EPWM_BRKCTL4_5_EADC1EBEN_Pos      (21)                                              /*!< EPWM_T::BRKCTL4_5: EADC1EBEN Position    */
#define EPWM_BRKCTL4_5_EADC1EBEN_Msk      (0x1ul << EPWM_BRKCTL4_5_EADC1EBEN_Pos)           /*!< EPWM_T::BRKCTL4_5: EADC1EBEN Mask        */

#define EPWM_BRKCTL4_5_EADC2EBEN_Pos      (22)                                              /*!< EPWM_T::BRKCTL4_5: EADC2EBEN Position    */
#define EPWM_BRKCTL4_5_EADC2EBEN_Msk      (0x1ul << EPWM_BRKCTL4_5_EADC2EBEN_Pos)           /*!< EPWM_T::BRKCTL4_5: EADC2EBEN Mask        */
...
#define EPWM_BRKCTL4_5_EADC1LBEN_Pos      (29)                                              /*!< EPWM_T::BRKCTL4_5: EADC1LBEN Position    */
#define EPWM_BRKCTL4_5_EADC1LBEN_Msk      (0x1ul << EPWM_BRKCTL4_5_EADC1LBEN_Pos)           /*!< EPWM_T::BRKCTL4_5: EADC1LBEN Mask        */

#define EPWM_BRKCTL4_5_EADC2LBEN_Pos      (30)                                              /*!< EPWM_T::BRKCTL4_5: EADC2LBEN Position    */
#define EPWM_BRKCTL4_5_EADC2LBEN_Msk      (0x1ul << EPWM_BRKCTL4_5_EADC2LBEN_Pos)           /*!< EPWM_T::BRKCTL4_5: EADC2LBEN Mask        */
...
#define EPWM_DACTRGEN_CUTRGEN0_Pos        (16)                                              /*!< EPWM_T::DACTRGEN: CUTRGEN0 Position      */
#define EPWM_DACTRGEN_CUTRGEN0_Msk        (0x1ul << EPWM_DACTRGEN_CUTRGEN0_Pos)             /*!< EPWM_T::DACTRGEN: CUTRGEN0 Mask          */

#define EPWM_DACTRGEN_CUTRGEN1_Pos        (17)                                              /*!< EPWM_T::DACTRGEN: CUTRGEN1 Position      */
#define EPWM_DACTRGEN_CUTRGEN1_Msk        (0x1ul << EPWM_DACTRGEN_CUTRGEN1_Pos)             /*!< EPWM_T::DACTRGEN: CUTRGEN1 Mask          */

#define EPWM_DACTRGEN_CUTRGEN2_Pos        (18)                                              /*!< EPWM_T::DACTRGEN: CUTRGEN2 Position      */
#define EPWM_DACTRGEN_CUTRGEN2_Msk        (0x1ul << EPWM_DACTRGEN_CUTRGEN2_Pos)             /*!< EPWM_T::DACTRGEN: CUTRGEN2 Mask          */

#define EPWM_DACTRGEN_CUTRGEN3_Pos        (19)                                              /*!< EPWM_T::DACTRGEN: CUTRGEN3 Position      */
#define EPWM_DACTRGEN_CUTRGEN3_Msk        (0x1ul << EPWM_DACTRGEN_CUTRGEN3_Pos)             /*!< EPWM_T::DACTRGEN: CUTRGEN3 Mask          */

#define EPWM_DACTRGEN_CUTRGEN4_Pos        (20)                                              /*!< EPWM_T::DACTRGEN: CUTRGEN4 Position      */
#define EPWM_DACTRGEN_CUTRGEN4_Msk        (0x1ul << EPWM_DACTRGEN_CUTRGEN4_Pos)             /*!< EPWM_T::DACTRGEN: CUTRGEN4 Mask          */

#define EPWM_DACTRGEN_CUTRGEN5_Pos        (21)                                              /*!< EPWM_T::DACTRGEN: CUTRGEN5 Position      */
#define EPWM_DACTRGEN_CUTRGEN5_Msk        (0x1ul << EPWM_DACTRGEN_CUTRGEN5_Pos)             /*!< EPWM_T::DACTRGEN: CUTRGEN5 Mask          */

#define EPWM_DACTRGEN_CDTRGEN0_Pos        (24)                                              /*!< EPWM_T::DACTRGEN: CDTRGEN0 Position      */
#define EPWM_DACTRGEN_CDTRGEN0_Msk        (0x1ul << EPWM_DACTRGEN_CDTRGEN0_Pos)             /*!< EPWM_T::DACTRGEN: CDTRGEN0 Mask          */

#define EPWM_DACTRGEN_CDTRGEN1_Pos        (25)                                              /*!< EPWM_T::DACTRGEN: CDTRGEN1 Position      */
#define EPWM_DACTRGEN_CDTRGEN1_Msk        (0x1ul << EPWM_DACTRGEN_CDTRGEN1_Pos)             /*!< EPWM_T::DACTRGEN: CDTRGEN1 Mask          */

#define EPWM_DACTRGEN_CDTRGEN2_Pos        (26)                                              /*!< EPWM_T::DACTRGEN: CDTRGEN2 Position      */
#define EPWM_DACTRGEN_CDTRGEN2_Msk        (0x1ul << EPWM_DACTRGEN_CDTRGEN2_Pos)             /*!< EPWM_T::DACTRGEN: CDTRGEN2 Mask          */

#define EPWM_DACTRGEN_CDTRGEN3_Pos        (27)                                              /*!< EPWM_T::DACTRGEN: CDTRGEN3 Position      */
#define EPWM_DACTRGEN_CDTRGEN3_Msk        (0x1ul << EPWM_DACTRGEN_CDTRGEN3_Pos)             /*!< EPWM_T::DACTRGEN: CDTRGEN3 Mask          */

#define EPWM_DACTRGEN_CDTRGEN4_Pos        (28)                                              /*!< EPWM_T::DACTRGEN: CDTRGEN4 Position      */
#define EPWM_DACTRGEN_CDTRGEN4_Msk        (0x1ul << EPWM_DACTRGEN_CDTRGEN4_Pos)             /*!< EPWM_T::DACTRGEN: CDTRGEN4 Mask          */

#define EPWM_DACTRGEN_CDTRGEN5_Pos        (29)                                              /*!< EPWM_T::DACTRGEN: CDTRGEN5 Position      */
#define EPWM_DACTRGEN_CDTRGEN5_Msk        (0x1ul << EPWM_DACTRGEN_CDTRGEN5_Pos)             /*!< EPWM_T::DACTRGEN: CDTRGEN5 Mask          */

#define EPWM_EADCTS0_TRGSEL0_Pos          (0)                                               /*!< EPWM_T::EADCTS0: TRGSEL0 Position        */
#define EPWM_EADCTS0_TRGSEL0_Msk          (0x1ful << EPWM_EADCTS0_TRGSEL0_Pos)              /*!< EPWM_T::EADCTS0: TRGSEL0 Mask            */
...
#define EPWM_EADCTS0_TRGSEL1_Msk          (0x1ful << EPWM_EADCTS0_TRGSEL1_Pos)              /*!< EPWM_T::EADCTS0: TRGSEL1 Mask            */
...
#define EPWM_EADCTS0_TRGSEL2_Msk          (0x1ful << EPWM_EADCTS0_TRGSEL2_Pos)              /*!< EPWM_T::EADCTS0: TRGSEL2 Mask            */
...
#define EPWM_EADCTS0_TRGSEL3_Msk          (0x1ful << EPWM_EADCTS0_TRGSEL3_Pos)              /*!< EPWM_T::EADCTS0: TRGSEL3 Mask            */
...
#define EPWM_EADCTS1_TRGSEL4_Msk          (0x1ful << EPWM_EADCTS1_TRGSEL4_Pos)              /*!< EPWM_T::EADCTS1: TRGSEL4 Mask            */
...
#define EPWM_EADCTS1_TRGSEL5_Msk          (0x1ful << EPWM_EADCTS1_TRGSEL5_Pos)              /*!< EPWM_T::EADCTS1: TRGSEL5 Mask            */
...
#define EPWM_DTCTL_RDTEN0_Pos             (0)                                               /*!< EPWM_T::DTCTL: RDTEN0 Position           */
#define EPWM_DTCTL_RDTEN0_Msk             (0x1ul << EPWM_DTCTL_RDTEN0_Pos)                  /*!< EPWM_T::DTCTL: RDTEN0 Mask               */

#define EPWM_DTCTL_RDTEN2_Pos             (1)                                               /*!< EPWM_T::DTCTL: RDTEN2 Position           */
#define EPWM_DTCTL_RDTEN2_Msk             (0x1ul << EPWM_DTCTL_RDTEN2_Pos)                  /*!< EPWM_T::DTCTL: RDTEN2 Mask               */

#define EPWM_DTCTL_RDTEN4_Pos             (2)                                               /*!< EPWM_T::DTCTL: RDTEN4 Position           */
#define EPWM_DTCTL_RDTEN4_Msk             (0x1ul << EPWM_DTCTL_RDTEN4_Pos)                  /*!< EPWM_T::DTCTL: RDTEN4 Mask               */

#define EPWM_DTCTL_FDTEN0_Pos             (8)                                               /*!< EPWM_T::DTCTL: FDTEN0 Position           */
#define EPWM_DTCTL_FDTEN0_Msk             (0x1ul << EPWM_DTCTL_FDTEN0_Pos)                  /*!< EPWM_T::DTCTL: FDTEN0 Mask               */

#define EPWM_DTCTL_FDTEN2_Pos             (9)                                               /*!< EPWM_T::DTCTL: FDTEN2 Position           */
#define EPWM_DTCTL_FDTEN2_Msk             (0x1ul << EPWM_DTCTL_FDTEN2_Pos)                  /*!< EPWM_T::DTCTL: FDTEN2 Mask               */

#define EPWM_DTCTL_FDTEN4_Pos             (10)                                              /*!< EPWM_T::DTCTL: FDTEN4 Position           */
#define EPWM_DTCTL_FDTEN4_Msk             (0x1ul << EPWM_DTCTL_FDTEN4_Pos)                  /*!< EPWM_T::DTCTL: FDTEN4 Mask               */

#define EPWM_DTCTL_DTCKSEL0_Pos           (16)                                              /*!< EPWM_T::DTCTL: DTCKSEL0 Position         */
#define EPWM_DTCTL_DTCKSEL0_Msk           (0x1ul << EPWM_DTCTL_DTCKSEL0_Pos)                /*!< EPWM_T::DTCTL: DTCKSEL0 Mask             */

#define EPWM_DTCTL_DTCKSEL2_Pos           (17)                                              /*!< EPWM_T::DTCTL: DTCKSEL2 Position         */
#define EPWM_DTCTL_DTCKSEL2_Msk           (0x1ul << EPWM_DTCTL_DTCKSEL2_Pos)                /*!< EPWM_T::DTCTL: DTCKSEL2 Mask             */

#define EPWM_DTCTL_DTCKSEL4_Pos           (18)                                              /*!< EPWM_T::DTCTL: DTCKSEL4 Position         */
#define EPWM_DTCTL_DTCKSEL4_Msk           (0x1ul << EPWM_DTCTL_DTCKSEL4_Pos)                /*!< EPWM_T::DTCTL: DTCKSEL4 Mask             */
