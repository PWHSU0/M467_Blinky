...
typedef struct
{
     ...
     * @var TIMER_T::PWMEXTETCTL
     * Offset: 0xB8  Timer PWM External Event Trigger Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |EXTETEN   |External Pin Event Trigger Enable Bit
     * |        |          |0 = External pin event trigger function Disabled.
     * |        |          |1 = External pin event trigger function Enabled.
     * |[5:4]   |CNTACTS   |Counter Action Selection
     * |        |          |00 = External pin event to trigger PWM counter reset.
     * |        |          |01 = External pin event to trigger PWM counter start.
     * |        |          |10 = External pin event to trigger PWM counter reset and start.
     * |        |          |11 = Reserved.
     * |[11:8]  |EXTTRGS   |External Trigger Pin Selection
     * |        |          |0000 = Trigger source form INT0 pin.
     * |        |          |0001 = Trigger source form INT1 pin.
     * |        |          |0010 = Trigger source form INT2 pin.
     * |        |          |0011 = Trigger source form INT3 pin.
     * |        |          |0100 = Trigger source form INT4 pin.
     * |        |          |0101 = Trigger source form INT5 pin.
     * |        |          |0110 = Trigger source form INT6 pin.
     * |        |          |0111 = Trigger source form INT7 pin.
     * |        |          |Other = Reserved.
     */
...
#define TIMER_EXTCTL_ECNTSSEL_Msk        (0x3ul << TIMER_EXTCTL_ECNTSSEL_Pos)              /*!< TIMER_T::EXTCTL: ECNTSSEL Mask         */
...
#define TIMER_PWMEXTETCTL_EXTETEN_Pos    (0)                                               /*!< TIMER_T::PWMEXTETCTL: EXTETEN Position */
#define TIMER_PWMEXTETCTL_EXTETEN_Msk    (0x1ul << TIMER_PWMEXTETCTL_EXTETEN_Pos)          /*!< TIMER_T::PWMEXTETCTL: EXTETEN Mask     */

#define TIMER_PWMEXTETCTL_CNTACTS_Pos    (4)                                               /*!< TIMER_T::PWMEXTETCTL: CNTACTS Position */
#define TIMER_PWMEXTETCTL_CNTACTS_Msk    (0x3ul << TIMER_PWMEXTETCTL_CNTACTS_Pos)          /*!< TIMER_T::PWMEXTETCTL: CNTACTS Mask     */

#define TIMER_PWMEXTETCTL_EXTTRGS_Pos    (8)                                               /*!< TIMER_T::PWMEXTETCTL: EXTTRGS Position */
#define TIMER_PWMEXTETCTL_EXTTRGS_Msk    (0xful << TIMER_PWMEXTETCTL_EXTTRGS_Pos)          /*!< TIMER_T::PWMEXTETCTL: EXTTRGS Mask     */
