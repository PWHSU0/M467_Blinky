...
/**
  ...
  * @note This average mode needs to work with accumulated mode that configured by ACU (EADC_MnCTL1[7:4], n=0~23) bit field.
  * \hideinitializer
  */
...
/**
  * @brief Set start of conversion interrupt delay cycle.
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32IntSel Decides which interrupt source will be used, valid value are from 0 to 3.
  * @param[in] u32DelayCycle Decides the interrupt delay cycle, valid value are from 0 to 15.
  * @return None
  * @details Select EADC start of conversion interrupt ADINT0 to ADINT3 delay cycle(s).
  * @note This function is workable only when any one of INTPOS (EADC_SCTLx[5]), x=0~15 is set.
  * \hideinitializer
  */
#define EADC_SET_INT_DELAY(eadc, u32IntSel, u32DelayCycle) ((eadc)->CTL = ((eadc)->CTL & ~(0xFUL << (EADC_CTL_INTDELAY0_Pos + ((u32IntSel) << 2)))) | \
                                                                          ((u32DelayCycle) << (EADC_CTL_INTDELAY0_Pos + ((u32IntSel) << 2))))

/**
  * @brief Enable comparetor to trigger EPWM brake.
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32CmpSel Decides which comparator will be used, valid value are from 0 to 3.
  * @return None
  * @details Enable EADC comparator 0 to 3 can trigger EPWM brake.
  * \hideinitializer
  */
#define EADC_ENABLE_CMP_TRIGGER_BRAKE(eadc, u32CmpSel) ((eadc)->CTL1 |= (1UL << (EADC_CTL1_CMP0TRG_Pos + (u32CmpSel))))

/**
  * @brief Disable comparetor to trigger EPWM brake.
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32CmpSel Decides which comparator will be disabled, valid value are from 0 to 3.
  * @return None
  * @details Disable EADC comparator 0 to 3 trigger EPWM brake.
  * \hideinitializer
  */
#define EADC_DISABLE_CMP_TRIGGER_BRAKE(eadc, u32CmpSel) ((eadc)->CTL1 &= (~(1UL << (EADC_CTL1_CMP0TRG_Pos + (u32CmpSel)))))
