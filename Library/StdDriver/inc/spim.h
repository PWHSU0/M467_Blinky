...
#define SPIM_DMM_MAP_ADDR      0x100000UL        /*!< DMM mode memory map base address    \hideinitializer */
#define SPIM_DMM_SIZE          0x100000UL        /*!< DMM mode memory mapping size        \hideinitializer */
